...
I am loading certs from the archive directory. I seem to remember chosing this was due to some file permission conflicts with mounting the files in docker.
